                        ...
                        <!-- Card Header - Dropdown -->
                            ...
                            <?php 
                                ...
                                if ($_SESSION["level"]=='Petugas' or $_SESSION["level"]=='petugas'){
                                    ...
                                    inner join petugas k on k.kode_petugas=p.kode_pengguna
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <?php 
                                        if ($_SESSION["level"]=='Petugas' or $_SESSION["level"]=='petugas'):
                                    ?>
                                    <img class="card-img" src="petugas/foto/<?php echo $data['foto'];?>" width="54px" alt="Card image">
                                    <?php endif; ?>

                                    <?php 
                                        if ($_SESSION["level"]=='Anggota' or $_SESSION["level"]=='anggota'):
                                    ?>
                                    <img class="card-img" src="anggota/foto/<?php echo $data['foto'];?>" alt="Card image">
                                    <?php endif; ?>
                                    </div>
                                </div>
                                <BR>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="80%">: <?php echo $data['nama_petugas'];?></td>
                                                    <?php endif; ?>
            ...
            <div class="modal-body">
                    <form action="profil/edit-profil.php" method="post" enctype="multipart/form-data">
                        <div class="card">
                            ...
                            <!-- Form edit profil untuk petugas -->  
                            <?php 
                                if ($_SESSION["level"]=='Petugas' or $_SESSION["level"]=='petugas'):
                            ?>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="id_petugas" value="<?php echo $data['id_petugas'];?>" type="hidden" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Nama:</label>
                                             <input name="nama" value="<?php echo $data['nama_petugas']?>" type="text" class="form-control" placeholder="Masukan nama" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <img src="petugas/foto/<?php echo $data['foto'];?>" width="50%" id="preview" class="img-thumbnail">
                                    </div>
                                </div>
                                <?php endif; ?>
