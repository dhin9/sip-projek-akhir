...
<main>
    <div class="container-fluid">
        ...
        <?php if ($_SESSION["level"]=='Petugas' or $_SESSION["level"]=='petugas'):?>
        <div class="row">
             <?php 
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col mr-2">
                        <div class="text-xs text-white text-uppercase mb-1">Peminjaman</div>
                        <div class="h5 mb-0 font-weight-bold text-white"><?php echo $total_peminjaman;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs text-white text-uppercase mb-1">Anggota</div>
                        <div class="h5 mb-0 font-weight-bold text-white"><?php echo $jumlah_anggota;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs text-white text-uppercase mb-1">Pustaka</div>
                        <div class="h5 mb-0 font-weight-bold text-white"><?php echo $jumlah_pustaka;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs text-white text-uppercase mb-1">Denda</div>
                        <div class="h5 mb-0 font-weight-bold text-white">Rp. <?php echo number_format($data['total_denda'],0,',','.');?></div>
                    </div>
                    <div class="col-auto">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-white"><?php echo $belum_diambil;?></div>
                    </div>
                    <div class="col-auto">
                        <i class="fa fa-shopping-bag fa-2x text-dark-300"></i>
                    </div>
                    </div>
                </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-white"><?php echo $sedang_dipinjam;?></div>
                    </div>
                    <div class="col-auto">
                        <i class="fa fa-hourglass-start fa-2x text-dark-300"></i>
                    </div>
                    </div>
                </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-white"><?php echo $telah_selesai;?></div>
                    </div>
                    <div class="col-auto">
                        <i class="fa fa-check-square fa-2x text-dark-300"></i>
                    </div>
                    </div>
                </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col-auto">
                        <i class="fa fa-bars fa-2x text-dark-300"></i>
                    </div>
                    </div>
                </div>
                </div>
