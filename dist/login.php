<?php
    ...
    $password = input(md5($_POST["password"]));
     ...
     //Query untuk cek pada tabel pengguna yang dijoinkan dengan tabel petugas
     $tabel_petugas= "select * from pengguna p
     inner join petugas k on k.kode_petugas=p.kode_pengguna
     where username='".$username."' and password='".$password."' limit 1";

     $cek_tabel_petugas = mysqli_query ($kon,$tabel_petugas);
     $petugas = mysqli_num_rows($cek_tabel_petugas);
    ...
    if ($petugas>0){
        ...
        $row = mysqli_fetch_assoc($cek_tabel_petugas);

        if ($row["status"]==1){
            
            //menyimpan data petugas dalam session
                                     ...
                                     <div class="card-body">
                                        ...
                                        <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4"  name="username" type="text" placeholder="Masukan Username" autocomplete="off" required  />
                                            </div>
                                            <div class="form-group">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-dark">Copyright &copy; <?php echo $data['nama_aplikasi'];?> <?php echo date('Y');?></div>
                        </div>
                    </div>
                </footer>
            </div>
